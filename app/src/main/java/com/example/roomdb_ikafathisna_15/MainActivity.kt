package com.example.roomdb_ikafathisna_15
...
import com.example.roomdb_ikafathisna_15.databinding.ActivityMainBinding
import com.example.roomdb_ikafathisna_15.room.Constant
import com.example.roomdb_ikafathisna_15.room.Movie
import com.example.roomdb_ikafathisna_15.room.MovieDb
...
class MainActivity : AppCompatActivity() {
    ...
    private fun deleteDialog(movie : Movie){
        ...
        alertDeleteDialog.apply {
            setTitle("Konfirmasi")
            setMessage("Ingin hapus sekarang? ${movie.title}")
